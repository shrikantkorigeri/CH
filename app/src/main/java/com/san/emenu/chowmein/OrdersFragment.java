...
public class OrdersFragment extends Fragment {
 ...
 //   ListView lv_plcdorders;
    ProgressDialog PD;

    List<ItemsBean> ordrditmList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // lv_plcdorders = (ListView) view.findViewById(R.id.lv_plcdorders);
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                for (int i = 0; i < ja.length(); i++) {
                                    ...
                                    ordrditmList.add(orditmbean);

                                }
                             //   lv_plcdorders.setAdapter(new OrdersAdapter(getActivity(), ordrditmList));
                                PD.dismiss();
                            } else if(success == 0){
